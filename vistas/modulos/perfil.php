			...
			<form method="post" onsubmit="return validarComentario()">
				...
				<div class="form-group">
					  ...
					  if($comentarios != ""){
						...
						echo ' <textarea class="form-control" rows="5" id="comentario" name="comentario" maxlength="300" required>'.$comentarios["comentario"].'</textarea>';
						
					}else{
					
						echo ' <textarea class="form-control" rows="5" id="comentario" name="comentario" maxlength="300" required></textarea>';
