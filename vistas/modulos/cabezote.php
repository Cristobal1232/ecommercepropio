...
<div class="container-fluid barraSuperior" id="top">
	...
	<div class="container">
		...
		<div class="row">
			...
			<!--=====================================
			LIsta de opciones del cabezote
			======================================-->	
			<nav class="navbar pruebaa">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						">
						    ...
						    <span class=" btn-default icon-bar "></span>
						    <span class=" btn-default icon-bar "></span>
							<span class=" btn-default icon-bar "></span> 
					...
					<div class="collapse navbar-collapse botonera" id="navbar-1">

							<ul class="nav navbar-nav">
								<li>
									<a class=" active" <?php echo'href="'.$url.'prueba"' ?>>Inicio </a>
								</li>

								<li>
									<a class="" <?php echo'href="'.$url.'"' ?>> Tienda </a>
								</li>

								<li>
									<a class="" <?php echo'href="'.$url.'"' ?>> Asesoramientos </a>
								</li>
					    	</ul>
